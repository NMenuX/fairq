      ...
      >
        {step === 2 && token ? (
          <Box sx={{ textAlign: 'center' }}>
            ...
            {token.estimated_wait_minutes !== undefined && token.estimated_wait_minutes !== null && (
              <Box sx={{ mt: 2, mb: 3, p: 2, bgcolor: '#EFF6FF', borderRadius: 2, border: '1px solid #BFDBFE' }}>
                <Typography variant="subtitle1" sx={{ color: '#1E40AF', fontWeight: 700 }}>
                  Estimated Wait: Approx. {token.estimated_wait_minutes} mins
                </Typography>
                <Typography variant="caption" sx={{ color: '#3B82F6' }}>
                  Based on current queue depth & historic data
                </Typography>
              </Box>
            )}
